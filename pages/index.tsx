...
const Home: NextPage = () => {
  ...
  const tabClass = (name: string) => {
    const defaults = `${styles["tab"]} block w-full px-6 xmd:px-0`;
  ...
  return (
    <>
      ...
      <main className="hidden lg:block">
        <Header />
        <div className={`flex xmd:grid grid-cols-12 ${styles["container"]}`}>
          <div className={`flex flex-col col-span-1 ${styles["left"]}`}>
            <button
            ...
            >
              ...
              >
                ...
                <p className="hidden xmd:block text-center font-semibold text-sm">
                  Workspace
                </p>
              </div>
            </button>
          ...
          <div className={`col-span-8 ${styles["right"]} w-full`}>
